...
public class NewCategoryCourseCompletionReport {
    public void NewCategoryCourseCompletionReport() throws IOException,InterruptedException {
        ...
        js.executeScript("arguments[0].value='01/01/2020'",From);
        Thread.sleep(500);
        WebElement To=driver.findElement(By.xpath("//*[@id=\"main\"]/div[2]/div/div[1]/div/div/div[2]/div[1]/input"));

        js.executeScript("arguments[0].value='03/03/2020'",To);
       ...
       //Select Course Category
        ...
        //Make the Course type Online and Search again
        //Select Course Type
        new Select(driver.findElement(By.xpath("/html[1]/body[1]/div[1]/div[2]/div[1]/div[1]/div[2]/div[2]/div[1]/div[11]/div[1]/select[1]"))).selectByVisibleText("Online");
        //Select Course Category
        new Select(driver.findElement(By.xpath("/html[1]/body[1]/div[1]/div[2]/div[1]/div[1]/div[2]/div[2]/div[1]/div[11]/div[2]/select[1]"))).selectByVisibleText(CreateAndEditCategory.ONline_Sub_Category_Name);

        Thread.sleep(2000);

        //Click on Go

        WebElement Go1=driver.findElement(By.xpath("//*[@id=\"main\"]/div[2]/div/div[15]/div/button[1]"));
        js.executeScript("arguments[0].click();",Go1);
