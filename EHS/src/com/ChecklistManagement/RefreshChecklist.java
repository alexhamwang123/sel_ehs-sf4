...
public class RefreshChecklist {
    public void NormalRefreshChecklist() throws InterruptedException, IOException {
        ...
        if(!driver.getPageSource().contains("Refresh courses can not have prerequisite courses")){
            Assert.fail("prereq course appeared, when checklist has prereq course option");
        }
        //Click Save
        driver.findElement(By.xpath("//button[@class='btn btn-primary btn-lg shadow rounded-circle']")).click();
