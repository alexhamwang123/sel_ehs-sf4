...
@Test
public class ChecklistPrerequisiteLInkedOR {
    public void ChecklistPrerequisiteLInkedOR()throws IOException,InterruptedException{
...
driver.findElement(By.xpath("/html/body/div[1]/main/div/div/div[2]/div[1]/ul/li[2]/a")).click();
        ...
        Wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//input[@placeholder='Type to filter result']")));
        driver.findElement(By.xpath("//input[@placeholder='Type to filter result']")).sendKeys(unfinishedChecklist);
        ...
        Wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//input[@placeholder='Type to filter result']")));
        driver.findElement(By.xpath("//input[@placeholder='Type to filter result']")).sendKeys(unfinishedClassroom);
        ...
        //click sencond link
        Wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/main/div/div/div[2]/div[1]/ul/li[3]/a")));
        driver.findElement(By.xpath("/html/body/div[1]/main/div/div/div[2]/div[2]/div[2]/div/div[2]/div/div[5]/div/div/div[2]/div/div[1]/button[2]")).click();

        //Click a random element to keep focusing on main page
        driver.findElement(By.xpath("/html/body/div[1]/main/div/div/div[2]/div[2]/div[2]/div/div[2]/div/div[2]/label")).click();
        Thread.sleep(1000);

        //Click first and
        driver.findElement(By.xpath("/html/body/div[1]/main/div/div/div[2]/div[2]/div[2]/div/div[2]/div/div[5]/div/div/div[2]/div/div[1]/button[1]")).click();
        ...
        //Click Second and
        driver.findElement(By.xpath("/html/body/div[1]/main/div/div/div[2]/div[2]/div[2]/div/div[2]/div/div[5]/div/div/div[3]/div/div[1]/button[1]")).click();
