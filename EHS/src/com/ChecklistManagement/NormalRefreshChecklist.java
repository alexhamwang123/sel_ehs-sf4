...
driver.findElement(By.xpath("/html/body/div[1]/main/div/div/div[2]/div[1]/ul/li[2]/a")).click();
            ...
            if(driver.getPageSource().contains("Refresh courses or courses that don't expire can not have refresh courses")){
                    Assert.fail("Refresh course appeared, when checklist has refresh course option");
            }
            //Click Save
            driver.findElement(By.xpath("//button[@class='btn btn-primary btn-lg shadow rounded-circle']")).click();
...
//          driver.findElement(By.partialLinkText("Classroom Course Management")).click();
        ...
        Thread.sleep(1000);
        driver.findElement(By.partialLinkText("Checklist Course Management")).click();
        Thread.sleep(1500);
        ...
        courseId1=CapitalLetter1.concat(courseId1);
