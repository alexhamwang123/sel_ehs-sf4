...
@Test
public class OnlinePrerequisiteLInkedAnd {
    public void OnlinePrerequisiteLInkedAnd() throws IOException, InterruptedException {
            ...
            //Click an element to be able to click save btn
            ...
            wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/main/div/div/div[2]/div[1]/ul/li[2]/a")));
            Thread.sleep(2000);
            driver.findElement(By.xpath("/html/body/div[1]/main/div/div/div[2]/div[2]/div[2]/div/div[2]/div/div[6]/div/div/div[3]/div/div[2]/div/button[2]")).click();
            ...
            //Click one element to be able to click save btn
            driver.findElement(By.id("course-trainingTime")).click();
