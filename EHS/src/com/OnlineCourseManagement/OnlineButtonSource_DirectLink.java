...
public class OnlineButtonSource_DirectLink {
    public void OnlineButtonSource() throws IOException, InterruptedException {
        ...
        driver.findElement(By.xpath("/html/body/div[1]/main/div/div/div[2]/div[2]/div[3]/div/div/div[2]/div/div/div[3]/button[1]")).click();
        ...
        Wait.until(ExpectedConditions.elementToBeClickable(driver.findElement(By.xpath("/html/body/div[1]/main/div/div/div[3]/div/form/button"))));
        Thread.sleep(1000);
