...
//@Test
@Test
public class OnlineButtonSource_DirectLink {
    public void OnlineButtonSource() throws IOException, InterruptedException {
        ...
        //CLick DirectLInk
        driver.findElement(By.xpath("/html/body/div[1]/div[2]/div/div/div[2]/div[2]/div[3]/div/div/div[2]/div/div/div[3]/button[1]")).click();

        //CLick OK Btn
        Thread.sleep(2000);
        WebElement OKBtn= driver.findElement(By.xpath("/html/body/div[4]/div[1]/div/div/footer/button[2]"));
        ...
        //wait for take course btn
        wait.until(ExpectedConditions.elementToBeClickable(driver.findElement(By.xpath("/html/body/div[1]/div[2]/div/div/div[3]/div/form/button"))));
        Thread.sleep(1000);
