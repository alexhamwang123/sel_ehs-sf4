...
public class OnlineCourseEditContent {
    public void OnlineCourseEditContent() throws InterruptedException, IOException {
        ...
        actions.click();
        actions.sendKeys("online testing");
        ...
        driver.findElement(By.name("detailCourseNo")).sendKeys("online testing arjun");
        Thread.sleep(1000);
        ...
        driver.findElement(By.id("detailCourseTitle")).sendKeys("online testing arjun");
        Thread.sleep(1000);
        ...
        Thread.sleep(1500);
        driver.findElement(By.name("courseContentTitle")).sendKeys("arjuns course title");
        Thread.sleep(500);
        ...
        Thread.sleep(1500);
        js.executeScript("tinyMCE.activeEditor.setContent('hooray for tinyMCE!')");
        Thread.sleep(500);
