...
public class CreateOfferingRegisterWithMgrUserAndEmail {
    public void CreateOfferingRegisterWithMgrUserAndEmail() throws InterruptedException, IOException {
       ...
       Thread.sleep(2000);
       driver.findElement(By.xpath("/html/body/div[1]/main/div/div/div[2]/div[2]/div[3]/div/div/div[2]/div[2]/table/tbody/tr/td[4]/div/button[3]")).click();

       //Click Edit Content Btn
       wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"classTimeTable\"]/tbody/tr/td[6]/div/button[2]")));
       Thread.sleep(2000);
       driver.findElement(By.xpath("//*[@id=\"classTimeTable\"]/tbody/tr/td[6]/div/button[2]")).click();
       ...
       Thread.sleep(2000);
       driver.findElement(By.xpath("/html/body/div[1]/main/div/div/div[2]/div[2]/div[3]/div/div/div/div[2]/div[7]/table/tbody/tr/td[5]/div/input")).clear();
       driver.findElement(By.xpath("/html/body/div[1]/main/div/div/div[2]/div[2]/div[3]/div/div/div/div[2]/div[7]/table/tbody/tr/td[5]/div/input")).sendKeys("020");
