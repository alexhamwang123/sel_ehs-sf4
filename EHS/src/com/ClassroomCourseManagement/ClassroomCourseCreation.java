...
@Test
public class ClassroomCourseCreation {
    public void ClassroomCourseCreation() throws IOException, InterruptedException {
       ...
       // WebElement SPG=driver.findElement(By.xpath("/html[1]/body[1]/div[1]/div[2]/div[1]/div[1]/div[2]/div[1]/div[2]/div[1]/div[3]/div[1]/input[1]"));
        ...
        //Mark as completed
        Thread.sleep(1000);
        new Select(driver.findElement(By.xpath("/html[1]/body[1]/div[1]/div[2]/div[1]/div[1]/div[2]/div[2]/div[3]/div[1]/div[1]/div[1]/div[2]/div[1]/div[2]/div[2]/div[1]/div[2]/div[1]/div[2]/select[1]"))).selectByVisibleText("Completed");
        Thread.sleep(500);

        //pick a class  & Assign prerequisite
        wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//input[@class='form-control']")));
        Thread.sleep(1000);
        driver.findElement(By.xpath("//input[@class='form-control']")).sendKeys("R82wQN7190");
