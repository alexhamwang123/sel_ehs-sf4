...
@Test
public class CreateFullOffering {
    public void CreateFullOffering() throws IOException, InterruptedException {
        ...
        new Select(driver.findElement(By.name("detailCourseCategory"))).selectByVisibleText("Suvey_Only_Selenium");
